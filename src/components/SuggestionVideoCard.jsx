  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
        <div className="flex mb-3">
          <div className="relative h-24 lg:h-20 w-40 min-w-[168px] lg:w-2 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl bg-slate-800 overflow-hidden">
          ...
          <div className="flex flex-col ml-3 overflow-hidden">
              ...
              <span className="text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7] flex items-center" >
                {video?.author?.title}
                {video?.author?.badges?.type == "VERIFIES_CHANNEL" && (
